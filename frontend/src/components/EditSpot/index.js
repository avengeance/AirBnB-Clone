...
const EditSpot = () => {
  ...
  useEffect(() => {
    const fetchSpot = async () => {
      const spot = await dispatch(getUserSpotsThunk(spotId));
      setSpot(spot);
      setFormValues({
        ...
        title: spot.title,
        price: spot.price,
        spotPreviewImage: spot.spotPreviewImage,
  ...
  const handleSubmit = async (e) => {
    ...
    await dispatch(editSpotThunk(payload, spotId)).then((spot) => {
...
// import { useEffect, useState } from "react";
// import { useDispatch, useSelector } from "react-redux";
// import { getUserSpotsThunk, editSpotThunk, getUserSpotsThunk } from "../../store/spots";
// import { useParams, useHistory } from "react-router-dom";
